...
var render = function() {
  ...
  return _c("div", { staticClass: "d-flex flex-column flex white lt" }, [
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      { staticClass: "list-item ", attrs: { "data-id": "item-5" } },
      [
        _c("span", { staticClass: "w-40 avatar circle blue-grey" }, [
        ...
        _c("div", { staticClass: "list-body" }, [
          _c(
            "a",
            {
              ...
              attrs: { href: "app.user.detail.html#item-5" }
            },
            [_vm._v("Сенаторов Сергей Андреевич")]
          ),
          _vm._v(" "),
